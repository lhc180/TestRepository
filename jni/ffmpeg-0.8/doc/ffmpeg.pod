...
I<c0> (first  pixel component)
I<c1> (second pixel component)
I<c2> (third  pixel component)
I<c3> (fourth pixel component, corresponds to the alpha component)
...
through the interface defined in F<libavfilter/vsink_buffer.h>.
